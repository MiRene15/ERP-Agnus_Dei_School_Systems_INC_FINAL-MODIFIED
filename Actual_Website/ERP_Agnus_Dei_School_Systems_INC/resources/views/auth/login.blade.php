...
<div x-data="{ loggingIn: false }">
    <div x-show="loggingIn" x-cloak style="position:fixed; inset:0; width:100vw; height:100vh; display:flex; align-items:center; justify-content:center; padding:16px; background: rgba(14,17,36,0.55); backdrop-filter: blur(6px); z-index: 9999; margin:0;">
