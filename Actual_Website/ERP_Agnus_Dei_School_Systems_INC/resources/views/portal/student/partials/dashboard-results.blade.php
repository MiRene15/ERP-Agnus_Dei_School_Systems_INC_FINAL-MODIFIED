...
<div class="mb-4 p-4 bg-amber-50 dark:bg-[rgba(251,191,36,0.12)] border border-amber-200 dark:border-[rgba(251,191,36,0.25)] rounded-lg text-amber-800 dark:text-[#FCD34D] text-sm flex items-start gap-3">
...
@if(!$student->student_number && !$pendingAdmission)
    <div class="bg-white dark:bg-[#1A1E3B] rounded-xl shadow-sm border border-gray-100 dark:border-[#2A2F58] p-6">
        <div class="flex items-center gap-4">
            ...
            <div class="flex-1">
                <h3 class="text-lg font-bold text-gray-900 dark:text-[#E8EAF6]">Start Your Application</h3>
                <p class="text-sm text-gray-600 dark:text-[#C1C4DC] mt-1">Complete your admission application to begin your journey at Agnus Dei School.</p>
            </div>
...
@elseif(!$student->student_number && $pendingAdmission)
    <div class="bg-white dark:bg-[#1A1E3B] rounded-xl shadow-sm border border-gray-100 dark:border-[#2A2F58] p-6">
        <div class="flex items-center gap-4">
            ...
            <div class="flex-1">
                <h3 class="text-lg font-bold text-gray-900 dark:text-[#E8EAF6]">Application Submitted</h3>
                <p class="text-sm text-gray-600 dark:text-[#C1C4DC] mt-1">#{{ $pendingAdmission->application_number }} — {{ $pendingAdmission->application_type }} Student for {{ $pendingAdmission->school_year }}. Upload your requirements while waiting.</p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div class="bg-white dark:bg-[#1A1E3B] rounded-xl shadow-sm border border-gray-100 dark:border-[#2A2F58] p-5">
            <div class="flex items-center gap-3 mb-3">
                ...
                <span class="text-sm font-medium text-gray-500 dark:text-[#8A90B0]">Enrollment</span>
            </div>
            <p class="text-xl font-bold text-gray-900 dark:text-[#E8EAF6]">{{ $activeEnrollment->section->grade_level }}</p>
            <p class="text-sm text-gray-600 dark:text-[#C1C4DC]">{{ $activeEnrollment->section->section_name }}</p>
        </div>
        ...
        <div class="bg-white dark:bg-[#1A1E3B] rounded-xl shadow-sm border border-gray-100 dark:border-[#2A2F58] p-5">
            <div class="flex items-center gap-3 mb-3">
                ...
                <span class="text-sm font-medium text-gray-500 dark:text-[#8A90B0]">Subjects</span>
            </div>
            <p class="text-xl font-bold text-gray-900 dark:text-[#E8EAF6]">{{ $activeEnrollment->subjects->count() }}</p>
            <p class="text-sm text-gray-600 dark:text-[#C1C4DC]">Enrolled subjects</p>
        </div>
        ...
        <div class="bg-white dark:bg-[#1A1E3B] rounded-xl shadow-sm border border-gray-100 dark:border-[#2A2F58] p-5">
            <div class="flex items-center gap-3 mb-3">
                ...
                <span class="text-sm font-medium text-gray-500 dark:text-[#8A90B0]">Status</span>
            </div>
            <p class="text-xl font-bold text-green-600">{{ $activeEnrollment->status }}</p>
            <p class="text-sm text-gray-600 dark:text-[#C1C4DC]">{{ $activeEnrollment->school_year }}</p>
        </div>
    </div>

    <div class="grid grid-cols-4 gap-3">
        <a href="{{ route('student.schedule') }}" class="bg-white dark:bg-[#1A1E3B] rounded-xl shadow-sm border border-gray-100 dark:border-[#2A2F58] p-4 flex flex-col items-center gap-2 hover:shadow-md dark:hover:shadow-lg transition">
            <div class="w-10 h-10 rounded-lg bg-purple-100 flex items-center justify-center">
            ...
            <span class="text-sm font-medium text-gray-700 dark:text-[#C1C4DC]">Schedule</span>
        </a>
        <a href="{{ route('student.ledger') }}" class="bg-white dark:bg-[#1A1E3B] rounded-xl shadow-sm border border-gray-100 dark:border-[#2A2F58] p-4 flex flex-col items-center gap-2 hover:shadow-md dark:hover:shadow-lg transition">
            <div class="w-10 h-10 rounded-lg bg-green-100 flex items-center justify-center">
                <svg class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
            </div>
            <span class="text-sm font-medium text-gray-700 dark:text-[#C1C4DC]">Account</span>
        </a>
        <a href="{{ route('student.report-card') }}" class="bg-white dark:bg-[#1A1E3B] rounded-xl shadow-sm border border-gray-100 dark:border-[#2A2F58] p-4 flex flex-col items-center gap-2 hover:shadow-md dark:hover:shadow-lg transition">
            <div class="w-10 h-10 rounded-lg bg-blue-100 flex items-center justify-center">
            ...
            <span class="text-sm font-medium text-gray-700 dark:text-[#C1C4DC]">Report Card</span>
        </a>
        <a href="{{ route('student.cor') }}" class="bg-white dark:bg-[#1A1E3B] rounded-xl shadow-sm border border-gray-100 dark:border-[#2A2F58] p-4 flex flex-col items-center gap-2 hover:shadow-md dark:hover:shadow-lg transition">
            <div class="w-10 h-10 rounded-lg bg-indigo-100 flex items-center justify-center">
                <svg class="w-5 h-5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2"/></svg>
            </div>
            <span class="text-sm font-medium text-gray-700 dark:text-[#C1C4DC]">COR</span>
        </a>
    </div>
@endif
