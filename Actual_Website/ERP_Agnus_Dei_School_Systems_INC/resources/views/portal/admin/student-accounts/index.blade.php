...
@section('breadcrumbs')
    ...
    <span class="current">Student Accounts</span>
@endsection

@section('content')
<div class="flex items-center justify-between mb-6">
    <div>
        <h2 class="text-2xl font-bold text-gray-900">Student Account Management</h2>
        <p class="text-gray-500 mt-1 text-sm">View, activate, deactivate, and reset passwords for student accounts.</p>
    </div>
</div>
