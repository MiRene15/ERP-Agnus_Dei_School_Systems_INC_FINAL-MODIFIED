...
@section('breadcrumbs')
    <a href="{{ route('admin.dashboard') }}" class="no-underline" style="color: var(--muted);">Dashboard</a><span class="opacity-40"> / </span><a href="{{ route('admin.sections.index') }}" class="no-underline" style="color: var(--muted);">Sections</a><span class="opacity-40"> / </span><span class="current">Edit</span>
@endsection
