...
<div x-data="{ open: {{ request()->routeIs('teacher.class-list*','teacher.grade-assessment*','teacher.computed-grades*','teacher.grade-table*') ? 'true' : 'false' }} }">
    <button @click="open = !open" class="sidebar-link w-full {{ request()->routeIs('teacher.class-list*','teacher.grade-assessment*','teacher.computed-grades*','teacher.grade-table*') ? 'active' : '' }}">
    ...
    <div x-show="open" x-transition.opacity.duration.200ms style="display: none;">
        ...
        <a href="{{ route('teacher.grade-table') }}" class="sidebar-link pl-12 {{ request()->routeIs('teacher.grade-table*') ? 'active' : '' }}">
            <span class="sidebar-label">Grade Table</span>
        </a>
