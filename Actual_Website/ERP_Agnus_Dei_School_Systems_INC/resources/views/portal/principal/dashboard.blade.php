...
@section('content')
<div class="mb-6">
    <h2 class="text-2xl font-bold text-gray-900 dark:text-[#E8EAF6]">School Principal Dashboard</h2>
    <p class="text-gray-600 dark:text-[#C1C4DC] mt-1">Manage schedules, view student grades, and create announcements.</p>
</div>
