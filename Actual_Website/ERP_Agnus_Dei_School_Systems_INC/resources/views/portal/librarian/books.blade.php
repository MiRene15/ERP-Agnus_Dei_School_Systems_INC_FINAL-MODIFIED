    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <form method="POST" :action="'/librarian/books/' + bookId + '/replace'">
                @csrf
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Replace Book</h3>
                    <p class="text-sm text-gray-600 mb-4">Create a replacement for: <strong x-text="bookTitle"></strong></p>
                    <p class="text-sm text-gray-500 mb-4">The original book will be deactivated and this new book will take its place.</p>
                    <div class="space-y-3">
                        <div>
