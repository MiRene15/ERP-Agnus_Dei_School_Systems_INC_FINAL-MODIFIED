...
@section('content')
<div class="mb-6">
    <h2 class="text-2xl font-bold text-gray-900 dark:text-[#E8EAF6]">Health & Wellness</h2>
    <p class="text-gray-600 dark:text-[#C1C4DC] mt-1">Track student health records, consultations, and medications.</p>
</div>
