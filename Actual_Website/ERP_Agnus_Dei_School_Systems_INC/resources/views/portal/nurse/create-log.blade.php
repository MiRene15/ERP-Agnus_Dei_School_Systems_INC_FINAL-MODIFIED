...
@section('content')
<div class="mb-6">
    <h2 class="text-2xl font-bold text-gray-900 dark:text-[#E8EAF6]">New Clinic Log</h2>
    <p class="text-gray-600 dark:text-[#C1C4DC] mt-1">Record a student clinic visit.</p>
</div>

<div class="bg-white dark:bg-[#1A1E3B] rounded-xl shadow-sm border border-gray-100 dark:border-[#2A2F58] p-6 max-w-2xl">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <textarea name="complaint" rows="2" placeholder="Describe the complaint or symptoms"
                          class="w-full rounded-lg border border-gray-300 dark:border-[#3B4172] dark:bg-[#23274C] dark:text-[#E8EAF6] px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">{{ old('complaint') }}</textarea>
            ...
            <div>
                ...
                <textarea name="diagnosis" rows="2" placeholder="Sickness or injury assessment"
                          class="w-full rounded-lg border border-gray-300 dark:border-[#3B4172] dark:bg-[#23274C] dark:text-[#E8EAF6] px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">{{ old('diagnosis') }}</textarea>
            ...
            <div>
                ...
                <textarea name="treatment" rows="2" placeholder="Treatment administered"
                          class="w-full rounded-lg border border-gray-300 dark:border-[#3B4172] dark:bg-[#23274C] dark:text-[#E8EAF6] px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">{{ old('treatment') }}</textarea>
            ...
            <div>
                ...
                <textarea name="notes" rows="2" placeholder="Additional notes"
                          class="w-full rounded-lg border border-gray-300 dark:border-[#3B4172] dark:bg-[#23274C] dark:text-[#E8EAF6] px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">{{ old('notes') }}</textarea>
